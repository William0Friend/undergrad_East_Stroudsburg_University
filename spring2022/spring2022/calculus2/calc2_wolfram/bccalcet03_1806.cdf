...
NotebookDataLength[    185165,       4446]
NotebookOptionsPosition[     24232,        827]
NotebookOutlinePosition[    181026,       4361]
CellTagsIndexPosition[    180915,       4356]
WindowTitle->Chapter D2 Review Exercises
WindowFrame->Normal*)
...
Cell[CellGroupData[{
Cell[TextData[StyleBox["CHAPTER D2\tREVIEW EXERCISES", "SectionTitleFont"]], \
"Section",ExpressionUUID->"1d9e9f85-8ab7-4ab4-849f-ec185b64bb3e"],

Cell[TextData[{
 StyleBox["1.\tExplain why or why not",
  FontWeight->"Bold"],
 "  Determine whether the following statements are true and give an example \
or a counterexample."
}], "Problem",ExpressionUUID->"e7b3daa8-85b5-4afa-b730-3205885c7d28"],
  ...
  FormBox[
   RowBox[{
    RowBox[{
     ...
     RowBox[{"2", 
      RowBox[{"y", "'"}]}], "-", 
     RowBox[{"t", " ", "y"}]}], "=", "0"}], TraditionalForm]],ExpressionUUID->
  "1c0c7d2a-b42c-4354-b6eb-b2df88cdd80d"],
 " is second-order, linear, and homogeneous."
}], "SubProblem",ExpressionUUID->"dd4df317-db14-4062-acc3-6f815cb82fbe"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  ...
  ExpressionUUID->"c1d25987-b145-4496-bcff-552765b868d9"],
 " is second-order, linear, and nonhomogeneous."
}], "SubProblem",ExpressionUUID->"7da90de5-45a0-4514-9f3d-711e9f4c4614"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  ...
  "32159d64-964d-445b-bae3-f87fa09b6b63"],
 ...
 Cell[BoxData[
  ...
  "f3671957-f0e3-4161-8b3a-aa9ddefd314a"],
 " and find ",
 Cell[BoxData[
  FormBox["r", TraditionalForm]],ExpressionUUID->
  "0499281d-5e88-417e-837c-e61fbce19d5f"],
 "."
}], "SubProblem",ExpressionUUID->"3d2af5d2-c1d3-4ce7-9d08-6bb53653d11a"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  ...
  "f5b66d44-7876-4c3d-b471-38cdded18952"],
 ", use the trial solution ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    RowBox[{"A", " ", 
     SuperscriptBox["e", "t"]}]}], TraditionalForm]],ExpressionUUID->
  "210721a5-5c78-433c-8e0d-c53d29aed46c"],
 "."
}], "SubProblem",ExpressionUUID->"d25231e1-a31c-4be9-a41d-26226f9ec076"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  ...
  "afc48ee4-50f2-40ac-adc5-fc237675da99"],
 " is always a solution of a second-order linear homogeneous equation."
}], "SubProblem",ExpressionUUID->"27040c4a-1bef-489d-9782-e694f748e8f1"],
...
Cell[TextData[{
 StyleBox["2",
  ...
  FontSlant->"Plain"],
 "\[Dash]",
 StyleBox["9. Solving homogeneous equations",
  FontWeight->"Bold",
  FontSlant->"Plain"],
 "  Find the general solution of the following homogeneous equations."
}], "ExerciseDirectionsCell",ExpressionUUID->"d394819f-c8e8-4b0c-95c9-\
2541f6821962"],
  ...
  FormBox[
   RowBox[{
    RowBox[{
     RowBox[{"y", "''"}], "+", 
     RowBox[{"y", "'"}], "-", 
     RowBox[{"6", "y"}]}], "=", "0"}], TraditionalForm]],ExpressionUUID->
  "e10a0884-de72-4fd8-a07e-90890317e74c"]
}], "Problem",ExpressionUUID->"890ff77b-b3c3-40bc-9e82-3915c57d0046"],
  ...
  FormBox[
   RowBox[{
    RowBox[{
     ...
     RowBox[{"2", 
      RowBox[{"y", "'"}]}], "-", 
     RowBox[{"8", "y"}]}], "=", "0"}], TraditionalForm]],ExpressionUUID->
  "799888d3-e72a-48b5-905e-fe24451c1de9"]
}], "Problem",ExpressionUUID->"cd1929f4-e7ca-46a3-9a9f-8e7a4d5c71f9"],
  ...
  FormBox[
   RowBox[{
    RowBox[{
     RowBox[{"y", "''"}], "+", 
     RowBox[{"8", "y"}]}], "=", "0"}], TraditionalForm]],ExpressionUUID->
  "07c4ed83-fe49-4a71-94e4-8616bc5c4c88"]
}], "Problem",ExpressionUUID->"d215e3a8-8fb5-418b-8bc2-24f8628b0b71"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  ...
  "709a4055-6b93-472c-b1ad-dc50319278bf"]
}], "Problem",ExpressionUUID->"c1fa2c48-4733-41cd-9583-af5e7d19f735"],
  ...
  FormBox[
   RowBox[{
    RowBox[{
     ...
     RowBox[{"4", 
      RowBox[{"y", "'"}]}], "+", 
     RowBox[{"13", "y"}]}], "=", "0"}], TraditionalForm]],ExpressionUUID->
  "66b8a45e-6f04-47e8-8571-0572ffe29904"]
}], "Problem",ExpressionUUID->"d0365442-4c30-42ec-87c8-c9b6fc2f2e20"],
   ...
   RowBox[{
    RowBox[{
     ...
     RowBox[{"4", 
      RowBox[{"y", "'"}]}], "+", 
     RowBox[{"4", "y"}]}], "=", "0"}], TraditionalForm]],ExpressionUUID->
  "de55bd38-ebb7-47d3-9ecb-d3f737c91d4c"]
}], "Problem",ExpressionUUID->"87c494ab-1d11-4ff4-8acb-8c3b47b0f512"],
   ...
   RowBox[{
    RowBox[{
     ...
     RowBox[{"3", "t", " ", 
      RowBox[{"y", "'"}]}], "+", 
     RowBox[{"8", "y"}]}], "=", "0"}], TraditionalForm]],ExpressionUUID->
  "21e30f96-10b9-4084-ac42-0160a958a013"],
 ", for ",
 Cell[BoxData[
  FormBox[
   RowBox[{"t", ">", "0"}], TraditionalForm]],ExpressionUUID->
  "f1b25ed2-fb57-40ab-8ffb-f0ce56f85008"]
}], "Problem",ExpressionUUID->"5357953d-3e6b-4a2f-af7e-6aaf8dae00e0"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  ...
  "a1d6f03a-bfc7-48e8-86a0-23958ec5bc2d"]
}], "Problem",ExpressionUUID->"ce9e76d4-bc85-4468-933f-6cdf784d611b"],
...
Cell[TextData[{
 StyleBox["10",
  ...
  FontSlant->"Plain"],
 "\[Dash]",
 StyleBox["15. Particular solutions",
  FontWeight->"Bold",
  FontSlant->"Plain"],
 "  Find a particular solution of the following equations."
}], "ExerciseDirectionsCell",ExpressionUUID->"07fb7b16-2b33-428e-bae5-\
52cc5063fafe"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  ...
  "b05054a5-8a06-4283-9996-8b059fd3b71c"]
}], "Problem",ExpressionUUID->"1ef8d24a-b1a9-45fd-9a0a-13f3f1ad9715"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  ...
  "b6ed2a33-9fb8-42ca-8351-4db4287ae056"]
}], "Problem",ExpressionUUID->"c209c930-c015-41ea-ad1f-d4f7955eb3ee"],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    RowBox[{
     RowBox[{"3", 
      SuperscriptBox["t", "2"]}], "+", "10"}]}], TraditionalForm]],
  ExpressionUUID->"f18d9096-4714-492e-b697-2e8507a653f4"]
}], "Problem",ExpressionUUID->"112625ca-f93e-4b38-b1e1-9db731ba3534"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  ...
  "af5a4d87-b923-46e0-9ca0-04e1e23b0274"]
}], "Problem",ExpressionUUID->"9892d94f-7d4a-4bec-8925-a7f7db7592ee"],
   ...
   RowBox[{
    ...
    RowBox[{"2", 
     SuperscriptBox["e", 
      RowBox[{
       RowBox[{"-", "2"}], "t"}]]}]}], TraditionalForm]],ExpressionUUID->
  "a4ea370a-c921-4786-b78e-6a58f10db43d"]
}], "Problem",ExpressionUUID->"33bccc0e-d883-4246-9dba-6685cbb44351"],
  ...
  FormBox[
   RowBox[{
    RowBox[{
     RowBox[{"y", "''"}], "+", 
     RowBox[{"16", "y"}]}], "=", 
    RowBox[{"2", "cos", " ", "4", "t"}]}], TraditionalForm]],ExpressionUUID->
  "30843886-0a4c-4a6c-9c84-f2a12e758b6b"]
}], "Problem",ExpressionUUID->"04872f31-aace-4661-b60e-d70c2c87c7bc"],
...
Cell[TextData[{
 StyleBox["16",
  ...
  FontSlant->"Plain"],
 "\[Dash]",
 StyleBox["21. General solutions",
  FontWeight->"Bold",
  FontSlant->"Plain"],
 "  Find the general solution of the following equations."
}], "ExerciseDirectionsCell",ExpressionUUID->"64296749-87ca-4ba8-8c8a-\
4cf771e2e961"],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    RowBox[{"4", 
     SuperscriptBox["e", "t"]}]}], TraditionalForm]],ExpressionUUID->
  "806f7aba-69d7-4c18-b00d-58f992beb0f1"]
}], "Problem",ExpressionUUID->"f412ce96-83a6-4e4a-867f-e810386ab4bf"],
  ...
  FormBox[
   RowBox[{
    RowBox[{
     RowBox[{"y", "''"}], "+", 
     RowBox[{"4", "y"}]}], "=", 
    RowBox[{"3", "sin", " ", "3", "t"}]}], TraditionalForm]],ExpressionUUID->
  "e6305d4b-a038-404d-a91f-69efde4fb232"]
}], "Problem",ExpressionUUID->"86534f44-7cc1-4cf0-90f7-2f578654e29b"],
  ...
  FormBox[
   RowBox[{
    ...
    RowBox[{"1", "+", 
     SuperscriptBox["e", 
      RowBox[{"-", "t"}]]}]}], TraditionalForm]],ExpressionUUID->
  "3d8dcea0-7598-43c6-bd90-8e681bb2eb72"]
}], "Problem",ExpressionUUID->"051b528b-0d4d-4665-bdb3-40a06578ec71"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  ...
  "8a1b2529-5b7c-4926-a88e-2946c8eb9ddc"]
}], "Problem",ExpressionUUID->"a6ef4e23-5b5e-4750-8cd9-d45d3091b6e3"],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    RowBox[{"1", "+", 
     RowBox[{"2", "t"}]}]}], TraditionalForm]],ExpressionUUID->
  "16c65891-e4d6-47f6-8283-f763242d961b"]
}], "Problem",ExpressionUUID->"16337ed0-d947-4c65-b357-af50670e54b4"],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    RowBox[{"2", 
     SuperscriptBox["e", "t"]}]}], TraditionalForm]],ExpressionUUID->
  "3ad61935-972a-4972-b8bc-c38853fc21d7"]
}], "Problem",ExpressionUUID->"6b4508b6-e205-4795-af98-c610027a08eb"],
...
Cell[TextData[{
 Cell[BoxData[
  ...
  "4b5c0064-0899-4022-bd61-f729c4bc96a9"],
 Cell[BoxData[
  StyleBox[
   GraphicsBox[{},
  ...
  "fe148064-dabf-4eea-b728-de90f843585c"],
 StyleBox["22.\tForced undamped oscillations",
  FontWeight->"Bold"],
 "  A 4-kg block hangs on a spring with spring constant ",
 Cell[BoxData[
  FormBox[
   RowBox[{"k", "=", 
    RowBox[{"16", 
  ...
  "79c83df7-4815-41d9-9a5d-afcefd3f9c5e"],
 ". The system is driven by an external force of ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["F", "ext"], "=", 
    RowBox[{"4", "cos", " ", "\[Omega]", "\[VeryThinSpace]", "t"}]}], 
   TraditionalForm]],ExpressionUUID->"e8a7f55d-139d-45d6-9127-6fc48a390aca"],
 ". Assume no initial displacement and velocity of the block, and no damping. \
Graph the solution in two cases: ",
 Cell[BoxData[
  FormBox[
   RowBox[{"\[Omega]", "=", "2.2"}], TraditionalForm]],ExpressionUUID->
  "ecc97fb5-84e8-41bf-b1c2-69c65f7edf52"],
 " and ",
 Cell[BoxData[
  FormBox[
   RowBox[{"\[Omega]", "=", "4"}], TraditionalForm]],ExpressionUUID->
  "05c0b423-09a6-4de5-b5b0-388807f5479b"],
 ". In which case does the solution have beats?"
}], "TProblem",ExpressionUUID->"54f58038-bf53-4c45-aeb3-b1d7efb6e96c"],
...
Cell[TextData[{
 Cell[BoxData[
  PaneBox[
   ...
   BaseStyle->{Background -> RGBColor[0, 0.3, 0.6]},
   ImageSize->{12, 14}]],ExpressionUUID->
  "fedefaf9-718a-4765-a135-9aa5b4931b7b"],
 Cell[BoxData[
  StyleBox[
   GraphicsBox[{},
    BaselinePosition->Baseline,
   ...
   CacheGraphics->False]],
  CellChangeTimes->{3.449270400725144*^9},ExpressionUUID->
  "e7512471-ad20-4838-b712-e04180b55fd6"],
 StyleBox["23.\tFree damped oscillations",
  FontWeight->"Bold"],
 "  A 0.2-kg block hangs on a spring with spring constant ",
 Cell[BoxData[
  FormBox[
   RowBox[{"k", "=", 
    RowBox[{"20", 
     RowBox[{
      ...
      StyleBox["m",
       FontSlant->Plain]}]}]}], TraditionalForm]],ExpressionUUID->
  "a73718fd-5f89-4d3a-8b11-54b532a01134"],
 ". Friction in the system is modeled with a damping coefficient of ",
 Cell[BoxData[
  FormBox[
   RowBox[{"c", " ", 
    RowBox[{"kg", "/", 
     StyleBox["s",
      FontSlant->Plain]}]}], TraditionalForm]],ExpressionUUID->
  "05213e3d-1ae0-48d5-894b-0caee54a638b"],
 ". Solve an initial value problem with the following values of ",
 Cell[BoxData[
  FormBox["c", TraditionalForm]],ExpressionUUID->
  "b73f30fa-5ef7-4cb2-a27e-351b5cde5c70"],
 " and initial conditions ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"y", "(", "0", ")"}], "=", "1"}], TraditionalForm]],
  ExpressionUUID->"59138ff5-e830-476a-a398-cb1640821450"],
 ", ",
 Cell[BoxData[
  FormBox[
   RowBox[{
  ...
  "678d128f-4c97-4c26-8202-5387a70c8850"],
 ". Graph each solution and state whether the problem exhibits underdamping, \
overdamping, or critical damping."
}], "TProblem",ExpressionUUID->"4377d120-4fbc-4228-a78d-fd5a7f1e543c"],
   ...
   RowBox[{"c", "=", 
    RowBox[{"3", 
     RowBox[{"kg", "/", 
      StyleBox["s",
       FontSlant->Plain]}]}]}], TraditionalForm]],ExpressionUUID->
  "3c09508b-0d08-4388-a6a6-f7cc3c1b5d5c"]
}], "SubProblem",ExpressionUUID->"6877d56c-39a5-4c15-a2a0-e562a6e4ac5e"],
   ...
   RowBox[{"c", "=", 
    RowBox[{"4", 
     RowBox[{"kg", "/", 
      StyleBox["s",
       FontSlant->Plain]}]}]}], TraditionalForm]],ExpressionUUID->
  "b19eae32-090e-4a48-9852-ce0a3e4202d1"]
}], "SubProblem",ExpressionUUID->"d37fdc50-8f26-4322-8cc2-84cfc4cd3e17"],
   ...
   RowBox[{"c", "=", 
    RowBox[{"5", 
     RowBox[{"kg", "/", 
      StyleBox["s",
       FontSlant->Plain]}]}]}], TraditionalForm]],ExpressionUUID->
  "00e68897-959b-4368-aef4-50a0cc4c4b3f"]
}], "SubProblem",ExpressionUUID->"cdb7647e-0fcb-466f-9c3d-3b37130027d5"],
...
Cell[TextData[{
 Cell[BoxData[
  PaneBox[
   ...
   BaseStyle->{Background -> RGBColor[0, 0.3, 0.6]},
   ImageSize->{12, 14}]],ExpressionUUID->
  "5fd9183b-1146-4063-bbab-d3bc91d664d8"],
 Cell[BoxData[
  StyleBox[
   GraphicsBox[{},
    BaselinePosition->Baseline,
   ...
   CacheGraphics->False]],
  CellChangeTimes->{3.449270400725144*^9},ExpressionUUID->
  "1bf71de1-c67f-409f-9191-1a13b2204f67"],
 StyleBox["24.\tForced damped oscillations",
  FontWeight->"Bold"],
 "  A 10-kg block hangs from a spring with spring constant ",
 Cell[BoxData[
  FormBox[
   RowBox[{"k", "=", 
    RowBox[{"62.5", 
     RowBox[{
      ...
      StyleBox["m",
       FontSlant->Plain]}]}]}], TraditionalForm]],ExpressionUUID->
  "afc98b42-9a34-4500-a895-c452710aeda2"],
 ". The block oscillates in a fluid that produces resistance with a damping \
constant ",
 Cell[BoxData[
  FormBox[
   RowBox[{"c", "=", 
    RowBox[{"40", 
     RowBox[{"kg", "/", 
      StyleBox["s",
       FontSlant->Plain]}]}]}], TraditionalForm]],ExpressionUUID->
  "b3fbd60b-a88a-41c1-86ae-74a0842ca272"],
 ". The support of the spring vibrates and produces an external force of ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["F", "ext"], "=", 
    RowBox[{"10", "cos", " ", "2", "t"}]}], TraditionalForm]],ExpressionUUID->
  "42e9e066-e00d-4b66-b2ef-2ad7e41dd51c"],
 ". Assume the block is initially at rest at the equilibrium position and \
released with no velocity."
}], "TProblem",ExpressionUUID->"9b33c812-2821-4bc8-a92a-e2ada9c6074b"],

Cell[TextData[{
 StyleBox["a.",
  FontWeight->"Bold"],
 "\tFind and graph the position of the block after it is released."
}], "SubProblem",ExpressionUUID->"b9e3ce39-d580-4e88-8458-909f95b3bf14"],

Cell[TextData[{
 StyleBox["b.",
  FontWeight->"Bold"],
 "\tIdentify the transient and steady-state solutions, and graph them \
separately. "
}], "SubProblem",ExpressionUUID->"61a8241f-8d4f-4d77-83da-7364392a99ec"],

Cell[TextData[{
 StyleBox["c.",
  FontWeight->"Bold"],
 "\tAfter approximately how many seconds does the transient solution become \
negligible?"
}], "SubProblem",ExpressionUUID->"3e60a424-99c5-4598-8215-bbda3a732425"],

Cell[TextData[{
 StyleBox["d.",
  FontWeight->"Bold"],
 "\tFind the position function of the block using a transfer function and \
confirm that your solution is consistent with part (a)."
}], "SubProblem",ExpressionUUID->"4f8c0d96-2662-4cef-a0f9-7ce6db640e0f"],
...
Cell[TextData[{
 Cell[BoxData[
  PaneBox[
   ...
   BaseStyle->{Background -> RGBColor[0, 0.3, 0.6]},
   ImageSize->{12, 14}]],ExpressionUUID->
  "8e902073-024f-4673-a7bd-da67dcdf34a4"],
 Cell[BoxData[
  StyleBox[
   GraphicsBox[{},
    BaselinePosition->Baseline,
   ...
   CacheGraphics->False]],
  CellChangeTimes->{3.449270400725144*^9},ExpressionUUID->
  "26a5064b-f1c9-436f-ba63-8736f72f085f"],
 StyleBox["25.\tAn LCR circuit",
  FontWeight->"Bold"],
 "  An LCR circuit consists of a 10-ohm resistor, a 0.1-henry inductor, and a \
",
 Cell[BoxData[
  FormBox[
   RowBox[{"1", "/", "240"}], TraditionalForm]],ExpressionUUID->
  "8423de82-21f7-4426-9ac9-7e034559ebb6"],
 "-farad capacitor connected in series to a variable voltage source with \
output ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"E", "(", "t", ")"}], "=", 
    RowBox[{"200", "sin", " ", "60", "t"}]}], TraditionalForm]],
  ExpressionUUID->"cec84330-63e0-45db-bf32-231b6590314c"],
 "."
}], "TProblem",ExpressionUUID->"850ff742-1e11-4703-a9db-2c364046c7b1"],

Cell[TextData[{
 StyleBox["a.",
  FontWeight->"Bold"],
 "\tFind the current in the circuit assuming that ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"I", "(", "0", ")"}], "=", 
  ...
  ExpressionUUID->"9c4338f9-c51b-4f76-96ca-eb2cbac1d681"],
 "."
}], "SubProblem",ExpressionUUID->"b96f9876-bbcd-4594-a35e-f694c750af64"],

Cell[TextData[{
 StyleBox["b.",
  FontWeight->"Bold"],
 "\tIdentify the transient and steady-state currents."
}], "SubProblem",ExpressionUUID->"55bdd122-856b-4e90-b440-ce5197d43082"],

Cell[TextData[{
 StyleBox["c.",
  FontWeight->"Bold"],
 "\tGraph the steady-state, transient, and total current, for ",
 Cell[BoxData[
  FormBox[
   RowBox[{"t", "\[GreaterEqual]", "0"}], TraditionalForm]],ExpressionUUID->
  "a82f99e2-6477-4d3c-b839-f75fe3d6c1e6"],
 "."
}], "SubProblem",ExpressionUUID->"16d35ffe-a0c0-4e7f-b088-f17c03d36fed"],

Cell[TextData[{
 StyleBox["d.",
  FontWeight->"Bold"],
 "\tFind the current using a transfer function and check for agreement with \
part (a)."
}], "SubProblem",ExpressionUUID->"18f11bbb-cce7-4033-8101-6f213f855451"],

Cell[CellGroupData[{

Cell["Chapter D2 Guided Projects  \[RightGuillemet]", "Subsubsubsubsection",
 CellTags->
  "\[EmptySmallCircle] Chapter D2 Guided \
Projects",ExpressionUUID->"d3eaff81-2de1-4f8a-9229-4b2e4f201373"],
...
information, see the Preface.",
 FontSlant->"Italic"]], "Text",ExpressionUUID->"6cbaabf8-aca9-4aac-bf6b-\
36d1521dccef"],

Cell["\[Bullet] Oscillators", "Text",ExpressionUUID->"0b6ab54c-b3c2-467a-8030-8a8a6709f987"]
}, Open  ]]
}, Open  ]]
},
Editable->True,
  ...
  BoxData[
   TagBox[
    GridBox[{{
       ...
       ActionMenuBox[
        StyleBox[
         TemplateBox[{"\"Ch \"", "\"D2\"", "\" Review\""}, "RowDefault"], 
         StripOnInput -> False], {StyleBox[
           TemplateBox[{
             ...
             "\"\[EmptySmallCircle] Chapter D2 Guided Projects\""}, 
            "RowDefault"], {"MSG", FontWeight -> "Plain", FontSize -> 11}, 
           StripOnInput -> False] :> {
           NotebookLocate["\[EmptySmallCircle] Chapter D2 Guided Projects"], 
           FrontEndExecute[{
...
bccalcet03_1805.cdf"], None}], ImageSize -> {20, 22}, Appearance -> "Palette",
       ...
       ButtonBox[
        PaneSelectorBox[{False -> GraphicsBox[{
         ...
         0], ButtonFunction :> NotebookLocate[{
           URL[
           "https://media.pearsoncmg.com/aw/aw_briggs_calculus_et_3/ebook/\
bccalcet03_1901.cdf"], None}], ImageSize -> {20, 22}, Appearance -> "Palette",
         ImageMargins -> 0, FrameMargins -> 0, Alignment -> Center, 
        BaselinePosition -> Center, Evaluator -> Automatic, Method -> 
        "Preemptive"], 
       InterpretationBox[
...
CellTagsIndex->{
 "\[EmptySmallCircle] Chapter D2 Guided Projects"->{
  Cell[23635, 812, 197, 3, 
  27, "Subsubsubsubsection", "ExpressionUUID" -> "
   d3eaff81-2de1-4f8a-9229-4b2e4f201373",
   CellTags->"\[EmptySmallCircle] Chapter D2 Guided Projects"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"\[EmptySmallCircle] Chapter D2 Guided Projects", 180706, 4348}
 }
*)
(*NotebookFileOutline
Notebook[{
...
"1d9e9f85-8ab7-4ab4-849f-ec185b64bb3e"],
Cell[1674, 39, 248, 5, 29, "Problem", "ExpressionUUID" -> \
"e7b3daa8-85b5-4afa-b730-3205885c7d28"],
Cell[1925, 46, 451, 14, 19, "SubProblem", "ExpressionUUID" -> \
"dd4df317-db14-4062-acc3-6f815cb82fbe"],
Cell[2379, 62, 460, 15, 23, "SubProblem", "ExpressionUUID" -> \
"7da90de5-45a0-4514-9f3d-711e9f4c4614"],
Cell[2842, 79, 810, 27, 23, "SubProblem", "ExpressionUUID" -> \
"3d2af5d2-c1d3-4ce7-9d08-6bb53653d11a"],
Cell[3655, 108, 683, 22, 24, "SubProblem", "ExpressionUUID" -> \
"d25231e1-a31c-4be9-a41d-26226f9ec076"],
Cell[4341, 132, 351, 9, 19, "SubProblem", "ExpressionUUID" -> \
"27040c4a-1bef-489d-9782-e694f748e8f1"],
Cell[4695, 143, 336, 10, 29, "ExerciseDirectionsCell", "ExpressionUUID" -> \
"d394819f-c8e8-4b0c-95c9-2541f6821962"],
Cell[5034, 155, 361, 12, 29, "Problem", "ExpressionUUID" -> \
"890ff77b-b3c3-40bc-9e82-3915c57d0046"],
Cell[5398, 169, 383, 13, 29, "Problem", "ExpressionUUID" -> \
"cd1929f4-e7ca-46a3-9a9f-8e7a4d5c71f9"],
Cell[5784, 184, 330, 11, 29, "Problem", "ExpressionUUID" -> \
"d215e3a8-8fb5-418b-8bc2-24f8628b0b71"],
Cell[6117, 197, 331, 11, 29, "Problem", "ExpressionUUID" -> \
"c1fa2c48-4733-41cd-9583-af5e7d19f735"],
Cell[6451, 210, 384, 13, 29, "Problem", "ExpressionUUID" -> \
"d0365442-4c30-42ec-87c8-c9b6fc2f2e20"],
Cell[6838, 225, 383, 13, 29, "Problem", "ExpressionUUID" -> \
"87c494ab-1d11-4ff4-8acb-8c3b47b0f512"],
Cell[7224, 240, 586, 20, 33, "Problem", "ExpressionUUID" -> \
"5357953d-3e6b-4a2f-af7e-6aaf8dae00e0"],
Cell[7813, 262, 383, 13, 29, "Problem", "ExpressionUUID" -> \
"ce9e76d4-bc85-4468-933f-6cdf784d611b"],
Cell[8199, 277, 318, 10, 29, "ExerciseDirectionsCell", "ExpressionUUID" -> \
"07fb7b16-2b33-428e-bae5-52cc5063fafe"],
Cell[8520, 289, 453, 16, 33, "Problem", "ExpressionUUID" -> \
"1ef8d24a-b1a9-45fd-9a0a-13f3f1ad9715"],
Cell[8976, 307, 369, 12, 29, "Problem", "ExpressionUUID" -> \
"c209c930-c015-41ea-ad1f-d4f7955eb3ee"],
Cell[9348, 321, 437, 15, 33, "Problem", "ExpressionUUID" -> \
"112625ca-f93e-4b38-b1e1-9db731ba3534"],
Cell[9788, 338, 481, 17, 31, "Problem", "ExpressionUUID" -> \
"9892d94f-7d4a-4bec-8925-a7f7db7592ee"],
Cell[10272, 357, 454, 16, 33, "Problem", "ExpressionUUID" -> \
"33bccc0e-d883-4246-9dba-6685cbb44351"],
Cell[10729, 375, 369, 12, 29, "Problem", "ExpressionUUID" -> \
"04872f31-aace-4661-b60e-d70c2c87c7bc"],
Cell[11101, 389, 314, 10, 29, "ExerciseDirectionsCell", "ExpressionUUID" -> \
"64296749-87ca-4ba8-8c8a-4cf771e2e961"],
Cell[11418, 401, 431, 15, 31, "Problem", "ExpressionUUID" -> \
"f412ce96-83a6-4e4a-867f-e810386ab4bf"],
Cell[11852, 418, 368, 12, 29, "Problem", "ExpressionUUID" -> \
"86534f44-7cc1-4cf0-90f7-2f578654e29b"],
Cell[12223, 432, 458, 16, 31, "Problem", "ExpressionUUID" -> \
"051b528b-0d4d-4665-bdb3-40a06578ec71"],
Cell[12684, 450, 416, 14, 29, "Problem", "ExpressionUUID" -> \
"a6ef4e23-5b5e-4750-8cd9-d45d3091b6e3"],
Cell[13103, 466, 431, 15, 29, "Problem", "ExpressionUUID" -> \
"16337ed0-d947-4c65-b357-af50670e54b4"],
Cell[13537, 483, 357, 12, 31, "Problem", "ExpressionUUID" -> \
"6b4508b6-e205-4795-af98-c610027a08eb"],
Cell[13897, 497, 1738, 51, 70, "TProblem", "ExpressionUUID" -> \
"54f58038-bf53-4c45-aeb3-b1d7efb6e96c"],
Cell[15638, 550, 1961, 60, 70, "TProblem", "ExpressionUUID" -> \
"4377d120-4fbc-4228-a78d-fd5a7f1e543c"],
Cell[17602, 612, 354, 12, 19, "SubProblem", "ExpressionUUID" -> \
"6877d56c-39a5-4c15-a2a0-e562a6e4ac5e"],
Cell[17959, 626, 354, 12, 19, "SubProblem", "ExpressionUUID" -> \
"d37fdc50-8f26-4322-8cc2-84cfc4cd3e17"],
Cell[18316, 640, 354, 12, 19, "SubProblem", "ExpressionUUID" -> \
"cdb7647e-0fcb-466f-9c3d-3b37130027d5"],
Cell[18673, 654, 1699, 51, 70, "TProblem", "ExpressionUUID" -> \
"9b33c812-2821-4bc8-a92a-e2ada9c6074b"],
Cell[20375, 707, 195, 4, 19, "SubProblem", "ExpressionUUID" -> \
"b9e3ce39-d580-4e88-8458-909f95b3bf14"],
Cell[20573, 713, 213, 5, 19, "SubProblem", "ExpressionUUID" -> \
"61a8241f-8d4f-4d77-83da-7364392a99ec"],
Cell[20789, 720, 218, 5, 19, "SubProblem", "ExpressionUUID" -> \
"3e60a424-99c5-4598-8215-bbda3a732425"],
Cell[21010, 727, 260, 5, 19, "SubProblem", "ExpressionUUID" -> \
"4f8c0d96-2662-4cef-a0f9-7ce6db640e0f"],
Cell[21273, 734, 1181, 36, 52, "TProblem", "ExpressionUUID" -> \
"850ff742-1e11-4703-a9db-2c364046c7b1"],
Cell[22457, 772, 403, 12, 19, "SubProblem", "ExpressionUUID" -> \
"b96f9876-bbcd-4594-a35e-f694c750af64"],
Cell[22863, 786, 182, 4, 19, "SubProblem", "ExpressionUUID" -> \
"55bdd122-856b-4e90-b440-ce5197d43082"],
Cell[23048, 792, 343, 9, 19, "SubProblem", "ExpressionUUID" -> \
"16d35ffe-a0c0-4e7f-b088-f17c03d36fed"],
Cell[23394, 803, 216, 5, 19, "SubProblem", "ExpressionUUID" -> \
"18f11bbb-cce7-4033-8101-6f213f855451"],
Cell[CellGroupData[{
Cell[23635, 812, 197, 3, 27, "Subsubsubsubsection", "ExpressionUUID" -> \
"d3eaff81-2de1-4f8a-9229-4b2e4f201373",
 CellTags->"\[EmptySmallCircle] Chapter D2 Guided Projects"],
Cell[23835, 817, 274, 4, 29, "Text", "ExpressionUUID" -> \
"6cbaabf8-aca9-4aac-bf6b-36d1521dccef"],
Cell[24112, 823, 92, 0, 29, "Text", "ExpressionUUID" -> \
"0b6ab54c-b3c2-467a-8030-8a8a6709f987"]
}, Open  ]]
}, Open  ]]
}
]
...
(* NotebookSignature PKz5lQSJckR5RJkyGPWYkIl1 *)
